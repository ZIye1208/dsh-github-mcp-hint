...
`;
    ...
    function GitHubHint() {
      ...
      return React.createElement("div", { className: "ghmcp-page" },
        ...
        React.createElement("div", { className: "ghmcp-page__status" }, "通过宿主侧接入 GitHub MCP → 工具以 mcp__github__* 形式出现。点示例可复制；统计含私有与克隆量请在对话里问我。若 mcp__github__* 没出现，先在对话里运行 github_token_status 确认 token，然后重启 DSH。"),
        userField,
        statsEl,
